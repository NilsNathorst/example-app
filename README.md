...
- `Semantic Light` — single mode, color aliases (free tier caps modes at 1 — Pro+ would collapse these into one collection with two modes).
...
2. Export with the [bb-extract](https://github.com/Nilsnathorst/bb-extract) plugin → save the JSON as `src/theme/tokens.json`.
